...
/// Keep in sync with reqy-web/lib/mock-types.ts (camelCase JSON).
/// Both sides must agree on the shape of MockRoute and its sub-types.
...
pub struct MockRoute {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub match_query_params: Option<HashMap<String, String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
