...
export function MessageEntry({ message }: MessageEntryProps) {
  ...
  return (
    ...
    >
      ...
      <pre
        className={cn(
          "text-sm font-mono leading-relaxed text-foreground whitespace-pre-wrap break-all",
      ...
      {showExpand && (
        <button
          ...
          className="text-sm font-medium text-muted-foreground/50 hover:text-foreground self-start mt-0.5"
        >
