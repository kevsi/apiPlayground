  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col px-3 pb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {messages.length > 0 && (
            <Button
              ...
              size="sm"
              onClick={handleClear}
              className="h-6 gap-1 text-sm font-medium text-muted-foreground/50 hover:text-destructive"
            >
      ...
      <div
        ...
        className="flex-1 min-h-0 overflow-auto border border-border rounded-lg bg-muted/10"
      >
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-sm text-muted-foreground/50">
