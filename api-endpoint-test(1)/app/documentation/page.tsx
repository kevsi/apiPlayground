...
export default function DocumentationPage() {
  ...
  return (
    <div className="flex h-screen bg-background bg-dot-pattern">
      <ApiSidebar activePage="documentation" collapsed={isCollapsed} onCollapse={toggleSidebar} />
      <div className={cn(
                ...
                <SectionCard icon={<FlaskConical className="size-4" />} title="Mock Server">
                  <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                    <p>
                      ...
                      It intercepts requests to <Code>/api/mock/&lt;path&gt;</Code> and returns configurable responses.
                    </p>
