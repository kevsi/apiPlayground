...
export function ApiSidebar({ activePage = "api-endpoints", collapsed: controlledCollapsed, onCollapse }: ApiSidebarProps) {
  ...
  const collapsed = (controlledCollapsed ?? internalCollapsed) || isNarrow
    ...
    >
      ...
      {!collapsed ? (
        <div className="px-3 py-2">
          <Link href="/ai-insights" className="flex w-full items-center gap-3 rounded-lg bg-gradient-to-r from-secondary to-accent px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:opacity-90">
