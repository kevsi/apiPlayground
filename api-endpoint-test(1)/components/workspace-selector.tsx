...
import { Plus, Check, Folder, Globe, Lock, Zap, Cloud, Terminal, Pencil, Trash2, FolderCode } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="flex size-6 shrink-0 items-center justify-center rounded-md text-muted-foreground/50 opacity-0 transition-all hover:bg-accent hover:text-foreground group-hover/ws:opacity-100"
                  title="Renommer"
                >
