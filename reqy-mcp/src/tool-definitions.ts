/**
 * Tool definitions for the Reqly MCP server.
 *
 * Each tool has a name, description, and JSON Schema for its input arguments.
 * Tools are grouped by domain: collections, requests, environments, runner, etc.
 *
 * Extracted from tools.ts to keep the handler file under 500 lines.
 */
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        color: {
          type: "string",
          description: "New color (slate, red, orange, amber, emerald, blue, indigo, violet, pink)",
        },
